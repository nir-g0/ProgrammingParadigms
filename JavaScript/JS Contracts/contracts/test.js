...
describe('isString()', function () {
  it('should return true if the argument is a string literal', function () {
    ...
    assert.equal(
      isString('I am the very model of a modern major general'),
      true
    )
  })
  it('should return true if the argument is a string object', function () {
    assert.equal(
      isString(new String('Llamé una vez a la visión y vino.')),
      true
    )
    assert.equal(isString(new String('Y era pálida y triste,')), true)
    assert.equal(
      isString(new String('y sus pupilas ardían como hogueras de martirios.')),
      true
    )
  })
...
describe('and()', function () {
  ...
  it('should return a function with an "expected" property set to something informative', function () {
    ...
    assert.equal(
      and(isNumber, isPositive, isDefined).expected,
      'number and positive number and defined'
    )
  })
})
...
describe('or()', function () {
  ...
  it('should return a function with an "expected" property set to something informative', function () {
    ...
    assert.equal(
      or(isNumber, isPositive, isDefined).expected,
      'number or positive number or defined'
    )
  })
})
